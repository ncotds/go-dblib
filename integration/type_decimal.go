...
// Code generated by "gen_type Decimal github.com/ncotds/go-dblib/*asetypes.Decimal -columndef decimal(38,19) -convert convertDecimal3819 -compare compareDecimal"; DO NOT EDIT.
...
func testDecimal(t *testing.T, db *sql.DB, tableName string) {
	...
	mySamples := make([]*asetypes.Decimal, len(samplesDecimal)*insert)
	...
	for i, sample := range samplesDecimal {
		...
		// insert)
		for j := 0; j < insert; j++ {
			mySamples[i+(len(samplesDecimal)*j)] = mySample
		}
	}
