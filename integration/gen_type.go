...
import (
	...
	"github.com/ncotds/go-dblib/flagslice"
)
...
func main() {
	...
	// -null "github.com/ncotds/go-dblib/asetypes.NullTime"
	// Split up to type "asetypes.NullTime" and import "github.com/ncotds/go-dblib/asetypes"
	if len(*fNull) > 0 {
...
// Example:
//
//	splitType("github.com/ncotds/go-dblib/asetypes.NullTime")
//	-> "github.com/ncotds/go-dblib/asetypes", "asetypes.NullTime"
//	splitType("github.com/ncotds/go-dblib/*asetypes.Decimal")
//	-> "github.com/ncotds/go-dblib/asetypes", "*asetypes.Decimal"
func splitType(input string) (string, string) {
	...
	if strings.Contains(input, "/") {
		// imp -> github.com/ncotds/go-dblib/asetypes
		imp = strings.Join(
			[]string{
	...
	// github.com/ncotds/go-dblib/*asetypes.Decimal
